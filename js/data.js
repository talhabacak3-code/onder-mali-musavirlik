...
const ONDER = (function () {
  const STORAGE_KEY = "onder_mevzuat_v1";
  ...
  const SEED = [
    ...
    },
    {
      ...
      tarih: "2025-11-20",
      kategori: "Duyuru",
      ozet: "Önder Mali Müşavirlik olarak, danışanlarımıza daha iyi hizmet verebilmek için yeni ofisimize taşındık. Afyonkarahisar Merkez'deki yeni adresimizde sizleri ağırlamaktan mutluluk duyarız.",
      icerik: "Yeni adresimiz: Akmescit, Yukarı Pazar Cd., No:64B, Afyonkarahisar Merkez/Afyonkarahisar.\n\nRandevu ve görüşmeleriniz için WhatsApp hattımızdan veya telefonla bize ulaşabilirsiniz. Kahvemiz hazır!"
    },
    {
      id: "seed-5",
